...
UUID=${UUID:-'8095d421-69ba-4bcb-905b-611a0e8d7176'}
VMESS_WSPATH=${VMESS_WSPATH:-'/8095d421-69ba-4bcb-905b-611a0e8d7176-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/8095d421-69ba-4bcb-905b-611a0e8d7176-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/8095d421-69ba-4bcb-905b-611a0e8d7176-trojan'}
SS_WSPATH=${SS_WSPATH:-'/8095d421-69ba-4bcb-905b-611a0e8d7176-shadowsocks'}
